  ...
  if (isset($_POST["submit"])) {
    ...
    <?php
      ...
      <div class="alert alert-warning" role="alert">
        Data gagal ditambahkan <a href="pemasukkan.php" class="alert-link">Klik disini untuk melihat tabel</a>.
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times</span>
        </button>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input id="FTanggalAkad" type="date" name="awal" class="form-control" required autocomplete="off">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="FTanggalAkhir">Tanggal Akhir Proteksi : </label>
            <input id="FTanggalAkhir" type="date" name="akhir" class="form-control" required autocomplete="off">
          </div>
        </div>
      </div>
      <div class="form-group">
        <label for="FNominal">Nominal Akad Kredit : </label>
        <input id="FNominal" type="number" name="nominal" class="form-control" placeholder="Dalam Satuan Rupiah dan Tanpa Titik" required autocomplete="off">
      </div>

            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="tahun" type="" name="tahun" class="form-control" placeholder="Masukkan tahun disini, contoh : 2020" required autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="persentase">Persentase : </label>
                        <input id="persentase" type="number" step="0.01" min="0" name="persentase" class="form-control" placeholder="Masukkan presentase disini, contoh : 1.5" required autocomplete="off">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="min" type="number" name="min" class="form-control" placeholder="Masukkan nominal minimal disini.. (Tanpa titik)" required autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="max">Maksimal : </label>
                        <input id="max" type="number" name="max" class="form-control" placeholder="Masukkan nominal maksimal disini.. (Tanpa titik)" required autocomplete="off">
                    </div>
                </div>
            </div>
